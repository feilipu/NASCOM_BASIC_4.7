...
This ROM works with the __Plus__ versions of the RC2014, with 64k of RAM and 8kb of ROM. This is the ROM to choose if you want fast I/O from a standard RC2014, together with the capability to upload and run C or assembly programs from within MS Basic.
...
For the RC2014 with 56k Nascom Basic the `USRLOC` loaded user program address is located at `0x2204`.
